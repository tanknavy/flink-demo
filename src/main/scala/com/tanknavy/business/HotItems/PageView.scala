...
/**
 * Author: Alex Cheng 12/3/2020 7:02 PM
 */
...
object PageView {
  def main(args: Array[String]): Unit = {
    ...
    val hotPerWindowStream = dataStream //DataStream[SensorReading]
      ...
      .timeWindowAll(Time.hours(1)) //没有keyBy下直接开窗
 ...
 */
    ...
    hotPerWindowStream.print("PV ") //没有输出，原因1,默认时间窗口按照process time而不是event time, 原因2，窗口时间太长，还没来得及关窗户计算程序就结束了



    //5. 执行
    env.execute("PV analysis")
  }
